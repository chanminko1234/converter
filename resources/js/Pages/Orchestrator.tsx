            ...
            <div className="py-6 space-y-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 transition-all pb-32">
                ...
                <header className="flex flex-col xl:flex-row xl:items-end justify-between gap-10">
                    <div className="space-y-6">
                        ...
                        <p className="text-xl text-foreground/60 dark:text-foreground/40 font-bold leading-relaxed tracking-tight max-w-2xl">
                    ...
                    <Card className="p-2 pt-3 pl-3 glass-card rounded-[3.5rem] border-foreground/10 dark:border-white/5 flex flex-wrap xl:flex-nowrap items-center gap-2 shadow-2xl ring-1 ring-foreground/5 dark:ring-white/5 bg-background/50 dark:bg-background/20 backdrop-blur-xl">
                        <div className="flex items-center bg-foreground/[0.05] dark:bg-foreground/[0.02] border border-foreground/10 dark:border-foreground/5 rounded-[2.8rem] px-8 py-3 gap-8 shadow-inner">
                            <div className="space-y-1">
                                <label className="text-[9px] font-black uppercase tracking-[0.2em] text-foreground/70 dark:text-foreground/30 leading-none">Source Registry</label>
                                <input
                                    className="bg-transparent border-none text-foreground focus:ring-0 p-0 text-[13px] font-black uppercase tracking-tight w-24 italic placeholder:text-foreground/40 dark:placeholder:text-foreground/20"
                                    placeholder="DB_ALPHA"
                                    value={sourceDb}
                                    onChange={e => setSourceDb(e.target.value)}
                                />
                            </div>
                            <div className="h-8 w-px bg-foreground/20 dark:bg-foreground/10" />
                            <div className="space-y-1">
                                <label className="text-[9px] font-black uppercase tracking-[0.2em] text-foreground/70 dark:text-foreground/30 leading-none">Target Sink</label>
                                <input
                                    className="bg-transparent border-none text-foreground focus:ring-0 p-0 text-[13px] font-black uppercase tracking-tight w-24 italic placeholder:text-foreground/40 dark:placeholder:text-foreground/20"
                        ...
                        <div className="flex p-1 bg-foreground/[0.07] dark:bg-foreground/[0.02] border border-foreground/10 dark:border-foreground/5 rounded-[2.8rem] gap-1 shadow-inner">
                            <Button
                                className={`rounded-full flex px-8 font-black uppercase text-[10px] tracking-widest transition-all ${isSimulating ? 'bg-primary text-primary-foreground shadow-glow-primary' : 'bg-background hover:bg-background/80 text-foreground dark:text-foreground/40 dark:bg-transparent dark:hover:bg-foreground/5 shadow-sm border border-foreground/5'}`}
                                onClick={() => {
                            ...
                            >
                                <PlayCircle className="w-4 mr-3 text-current" />
                                {isSimulating ? 'Offline Simulator' : 'Engage Matrix'}
                            </Button>
                            <Button
                                variant="ghost"
                                className="rounded-full h-14 w-14 p-0 text-foreground/60 dark:text-foreground/30 hover:text-primary transition-all active:rotate-180 duration-500"
                                onClick={() => fetchStatus()}
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <Card className="glass-card rounded-[3.5rem] border-foreground/10 dark:border-white/5 p-10 relative overflow-hidden group shadow-2xl shadow-foreground/[0.03] dark:shadow-2xl">
                        ...
                        <div className="relative z-10 space-y-4">
                            <div className="flex items-center gap-4 mb-8">
                                <div className="h-12 w-12 bg-primary/10 rounded-2xl flex items-center justify-center border border-primary/10 ring-1 ring-primary/20 shadow-sm">
                                    <Activity className="h-6 w-6 text-primary shadow-glow-primary" />
                                </div>
                                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground/70 dark:text-foreground/30">Throughput Metric</span>
                            </div>
                            ...
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground/70 dark:text-foreground/30 pt-6">Active Shard Throughput Analysis</p>
                        </div>
                    ...
                    <Card className="glass-card rounded-[3.5rem] border-foreground/10 dark:border-white/5 p-10 relative overflow-hidden shadow-2xl shadow-foreground/[0.03] dark:shadow-2xl">
                        <div className="flex items-center gap-4 mb-8">
                            <div className="h-12 w-12 bg-emerald-500/10 rounded-2xl flex items-center justify-center border border-emerald-500/10 ring-1 ring-emerald-500/20 shadow-sm">
                                <Globe className="h-6 w-6 text-emerald-500 shadow-glow-emerald" />
                            </div>
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground/70 dark:text-foreground/30">Cluster Aggregation</span>
                        </div>
                        <div className="space-y-8 relative z-10">
                            <div className="flex justify-between items-end">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-600 dark:text-emerald-500/60 leading-none">Global Sync Packets</p>
                                </div>
                                <div className="text-right space-y-1">
                                    <span className="text-2xl font-black text-foreground italic">{metrics?.progress_pct ?? 0}%</span>
                                    <p className="text-[9px] font-black uppercase tracking-widest text-foreground/70 dark:text-foreground/30 leading-none">Sync Score</p>
                                </div>
                            </div>
                            <div className="space-y-2">
                                <Progress value={metrics?.progress_pct ?? 0} className="h-2 bg-foreground/10 dark:bg-foreground/5 overflow-hidden rounded-full shadow-inner" />
                            </div>
                        </div>
                    </Card>

                    <Card className="glass-card rounded-[3.5rem] border-foreground/10 dark:border-white/5 p-10 flex flex-col justify-between shadow-2xl shadow-foreground/[0.03] dark:shadow-2xl">
                        <div className="flex items-center gap-4 mb-8">
                            <div className="h-12 w-12 bg-amber-500/10 rounded-2xl flex items-center justify-center border border-amber-500/10 ring-1 ring-amber-500/20 shadow-sm">
                                <ShieldCheck className="h-6 w-6 text-amber-500 shadow-glow-amber" />
                            </div>
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground/70 dark:text-foreground/30">Operational Integrity</span>
                        </div>
                        <div className="space-y-5">
                            <div className="flex items-center justify-between text-[11px] font-black py-4 border-b border-foreground/10 dark:border-foreground/5 uppercase tracking-widest">
                                <span className="text-foreground/40 dark:text-foreground/20 italic">Primary Streams</span>
                                <span className="text-foreground">{metrics?.active_streams ?? 0} Units</span>
                            </div>
                            <div className="flex items-center justify-between text-[11px] font-black py-4 border-b border-foreground/10 dark:border-foreground/5 uppercase tracking-widest">
                                <span className="text-foreground/40 dark:text-foreground/20 italic">Shards Unlinked</span>
                            ...
                            <div className="flex items-center justify-between text-[11px] font-black py-4 uppercase tracking-widest">
                                <span className="text-foreground/40 dark:text-foreground/20 italic">Node Latency</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-8">
                        <Card className="h-full glass-card rounded-[4rem] border-foreground/10 dark:border-white/5 p-12 shadow-2xl shadow-foreground/[0.03] dark:shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="flex items-center justify-between mb-12 relative z-10">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-foreground/40 dark:text-foreground/20 italic">High-Frequency Operational Analysis</p>
                                </div>
                                ...
                                <ResponsiveContainer width="100%" height="100%">
                                    <LineChart data={throughputHistory}>
                                        ...
                                        <Tooltip
                                            ...
                                            labelStyle={{ color: 'hsla(var(--foreground), 0.4)', fontSize: '9px', fontWeight: 900, textTransform: 'uppercase', marginBottom: '8px' }}
                                            itemStyle={{ color: 'hsl(var(--primary))', fontSize: '13px', fontWeight: 900, textTransform: 'uppercase', fontStyle: 'italic' }}
                                        />
                                        <Line
                                            type="monotone"
                                            dataKey="val"
                    ...
                    <div className="lg:col-span-4">
                        <Card className="h-full glass-card rounded-[4rem] border-foreground/10 dark:border-white/5 overflow-hidden shadow-2xl shadow-foreground/[0.03] dark:shadow-2xl flex flex-col group">
                            <div className="p-10 border-b border-foreground/10 dark:border-foreground/5 bg-foreground/[0.01] flex items-center justify-between">
                                <div className="space-y-1">
                                    <h3 className="text-2xl font-black tracking-tighter uppercase italic text-foreground leading-none">Stream Shards</h3>
                                    <p className="text-[9px] font-black uppercase tracking-[0.3em] text-foreground/40 dark:text-foreground/20 italic">Node Observability</p>
                                </div>
                                <div className="h-10 w-10 bg-foreground/5 rounded-2xl flex items-center justify-center border border-foreground/10 dark:border-foreground/5 shadow-sm">
                                    <Settings className="h-5 w-5 text-foreground/30 dark:text-foreground/20 group-hover:rotate-90 transition-transform duration-500" />
                                </div>
                            </div>
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-4 relative z-10">
                                            <div className="flex items-center gap-5">
                                                <div className="h-10 w-10 bg-background dark:bg-foreground/5 rounded-xl flex items-center justify-center border border-foreground/10 dark:border-foreground/5 shadow-sm">
                                                    <Table className="h-4 w-4 text-foreground/30 dark:text-foreground/20 group-hover/item:text-primary transition-colors" />
                                                </div>
                                        ...
                                        <div className="space-y-4 relative z-10">
                                            <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-[0.2em] text-foreground/40 dark:text-foreground/20 italic">
                ...
                <AnimatePresence>
                    {metrics?.progress_pct >= 100 && (
                        ...
                        >
                            <div className="max-w-4xl mx-auto p-1.5 bg-gradient-to-r from-emerald-500/40 via-primary/30 to-emerald-500/40 rounded-[4rem] shadow-[0_40px_100px_rgba(0,0,0,0.2)] dark:shadow-[0_40px_100px_rgba(0,0,0,0.5)]">
                                <div className="p-12 rounded-[3.8rem] bg-background/90 backdrop-blur-3xl flex flex-col md:flex-row items-center justify-between gap-10 border border-foreground/10 dark:border-white/10 ring-1 ring-foreground/5 dark:ring-white/5">
